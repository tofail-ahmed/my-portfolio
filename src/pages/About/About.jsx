  ...
  return (
    <div id='about'>
      ...
      <div className='text boat text-green-400 mx-auto my-24 text-justify'>
        ...
        <div>
          As a web developer, I believe in clean and efficient code that follows best practices. I pay attention to detail and strive for pixel-perfect designs that are responsive and accessible across different devices and browsers
        </div>
        <div className='boatabout my-4'>
          Im excited to collaborate on challenging projects and contribute to the success of your team. If youre looking for a dedicated and passionate web developer, Id love to hear from you. Lets create something amazing together!
        </div>
      </div>
    </div>
