...
import college from '../../assets/admission-guru.png'
                  ...
                  <div className='grid md:grid-cols-2  gap-8 my-12 '>
                        <div className='bgcontainer'>
                              <div className=" boat card md:w-[500px]  text-slate-300 shadow-xl mx-auto bg-green-800" >
                                    <div>
                                          <a href="https://college-client-adeee.web.app/" target='_blank'> <figure><img className='md:w-[550px] md:h-[250px]' src={college} alt="Shoes" /></figure></a>
                                    </div>
                                    <div className='text-emerald-950 text text-start m-4 font-bold'>Campus Guru - an addmission website where ampuses with details are found</div>
                                    ...
                                    <div className='my-4 mx-auto'>
                                          <a href="https://github.com/tofail-ahmed/college-client" target='_blank'><span className='text-md text-lime-900 bg-lime-400 rounded-sm font-bold w-[80px] text-center m-2 '>Github</span></a>

                                          <a href="https://college-client-adeee.web.app/" target='_blank'><span className='text-md text-lime-900 bg-lime-400 rounded-sm font-bold w-[80px] text-center m-2 '>Live Site</span></a>
                        ...
                        <div className='bgcontainer'>
                              <div className=" boat card md:w-[500px]  text-slate-300 shadow-xl mx-auto bg-green-800" >
                                    <div>
                                          <a href="https://tofailahmedportfolio.netlify.app/" target='_blank'> <figure><img className='md:h-[250px] md:w-[550px]' src={portfolio} alt="Shoes" /></figure></a>
                                    </div>
